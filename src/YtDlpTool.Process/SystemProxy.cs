...
///  2. WinHTTP auto-proxy resolution (WPmanagedDHCP/DNS discovery + AutoConfigURL PAC)
...
///     or relies on WPmanagedauto-detect.
/// </summary>
public static class SystemProxy
{
    ...
    public static string? DetectHttpProxy()
    {
        ...
        // Stage 2: WinHTTP auto-proxy (WPmanaged/ PAC) — what domain-joined machines use.
        try
        {
    ...
    /// would use for the given URL. Honours WPmanagedauto-detection (DHCP option 252
    /// and DNS A "wpad" lookup) and a manually set AutoConfigURL PAC. Returns null
    /// when WPmanageddoesn't resolve to anything or when WinHTTP is unavailable.
    /// </summary>
    [SupportedOSPlatform("windows")]
